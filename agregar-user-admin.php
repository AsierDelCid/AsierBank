...
if(mysqli_affected_rows($conexion)>0){
  ...
  exit;
    ...
    if(mysqli_affected_rows($conexion)>0){
        ...
        if($rango == 4){
            header("location: ./agregar-user-director.php");exit;
        }
    }
    $contador = 0;
...
<input type="text" id="nombresillo" name="nombresillo" required autocomplete="off">
...
<input type="text" id="userappnom" name="userappnom" required autocomplete="off">
...
<div class="row">
<div class="col s4">
<a href="#modal1" class="modal-trigger" style="background: black; padding: 20px; border-radius: 10px; font-size: 20px;"><i style="color: yellow;"class="fas fa-exclamation"></i></i></a>
</div>
